      ...
      label: (
        <View
          style={{
            ...
            paddingTop: Platform.OS == "ios" ? Config.deviceHeight * 0.005 : 0,
          }}
        >
          <Text
            style={{
      ...
      <Pressable onPress={() => Keyboard.dismiss()} style={styles.container}>
        ...
        >
          ...
          >
                    ...
                    styles.headText,
                    {
                      fontSize:
                        Config.deviceWidth < 768
                          ...
                          : 54 + (Config.deviceWidth * 0.025 - 20),
                    },
                  ]}
                >
            ...
            <TouchableOpacity
              ...
              style={{
                marginVertical:
                  Platform.OS === "ios" ? Config.deviceHeight * 0.005 : 0,
              }}
            >
              <Text
                style={[
                  ...
                  ,
                  {
                    fontSize:
                      Config.deviceWidth < 768
                        ...
                        : 23 + (Config.deviceWidth * 0.01 - 7.5),
                  },
                ]}
              >
        ...
        {Platform.OS == "android" && (
          <View style={{ flexDirection: "row", marginTop: "auto" }}>
            ...
            >
              <Text style={[styles.headText, { color: Colors.SecondaryLight }]}>
